...
- (void)applicationWillFinishLaunching:(NSNotification *)notification{
    NSInteger daysLeft = [ISExpirationManager daysLeftUntilExpiration:14 withCompileTimeZone:[NSTimeZone timeZoneWithName:@"PST"]];
...
@interface ISAppExperation : NSObject
